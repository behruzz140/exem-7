  ...
  return (
    <div>
      {title === "post" ? 
        <button
          onClick={handleOpen}
          className="py-2 px-6 text-white font-semibold bg-[#007BFF] hover:bg-[#0056b3] active:bg-[#007BFF] duration-200 rounded-lg"
        >
          ADD BRAND
        </button> 
      : 
          ...
          >
            {({ setFieldValue }) => (
              <Form className="max-w-[600px] w-full flex flex-col gap-[12px]">
                <h1 className="text-center mb-2 text-[26px] font-bold text-[#007BFF]">
                ...
                <Button
                  sx={{ fontSize: "16px", fontWeight: "600", backgroundColor: "#007BFF", "&:hover": { backgroundColor: "#0056b3" } }}
                  variant="contained"
                  type="submit"
