          ...
          <div className="px-3 pt-4">
            ...
            >
                ...
                <Form className="w-full flex flex-col gap-[8px]">
                  <h2 className="text-center text-[#007FFF] text-[22px] pb-4 font-semibold">Edite product details</h2>
                  ...
                  <Button
                    sx={{ fontSize: "16px", fontWeight: "600", padding: "14px", backgroundColor: "#007FFF", "&:hover": { background: "#0000FF" } }}
                    variant="contained"
                    type="submit"
                    className="w-[100%]"
                  >
  ...
  return (
    <div>
      <button
        ...
        className="py-2 px-5 rounded-md bg-[#007FFF] text-white font-medium hover:bg-[rgb(60,68,137)] duration-300 active:bg-[#232963]"
      >
        Edite
      </button>
